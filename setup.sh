...
echo "Installing dependencies (git, gcc, ripgrep, go, rust, python-pip, lua-jsregexp)..."
sudo pacman -S --needed git gcc ripgrep go rustup python-pip lua-jsregexp
...
echo "Installing pynvim for Python provider using uv..."
# Create a virtual environment and install pynvim
...
return {
  {
    ...
    config = function()
      ...
      -- Auto-open nvim-tree on Neovim start
